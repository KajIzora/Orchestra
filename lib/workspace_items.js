...
// folder's window and switches to its Space in ~0.05s, vs ~1.1s for the `cursor`
// node CLI. Keep in sync with public/default_launch_commands.js, lib/focus.js,
...
function buildCursorProjectCommand(source, workspacePath, remoteHost) {
  ...
  return `open -b ${CURSOR_BUNDLE_ID} ${shellQuote(targetPath)}`;
}
